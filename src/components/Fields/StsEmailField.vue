<template>
    ...
    <div class="field" v-if="showField">
        ...
        <div :class="{'control': true, 'has-icons-right': hasError}">
            <input :key="'field-' + _uid" :id="field.model" type="email" :class="{'input': true, 'is-danger': hasError}" :name="field.name" :placeholder="field.placeholder" v-model.trim="fieldModels[field.model]" :disabled="field.disabled"></input>
